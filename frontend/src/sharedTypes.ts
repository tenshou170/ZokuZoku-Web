// Mock HachimiCommand as we don't have the IPC definition from the extension
...
export interface ITextSlot<UD = any> {
    content: string;
    multiline?: boolean;
    // userData?: UD; // Removed duplicate
    link?: TreeNodeId;
    tooltip?: string;
    userData?: UD | any; // Allow relaxed typing but keep generic
}
